...
#remove tmp files from previous alignments if they are present
...
cmd.gz<-paste("STAR --genomeDir ", ref_dir, " --readFilesIn ", x, " --readFilesCommand zcat --runThreadN 7 --outSAMtype BAM SortedByCoordinate --scoreDelOpen -10000 --scoreInsOpen -10000 --outFilterMultimapNmax 1 --outFilterMismatchNmax 2 --outSAMunmapped Within --outFileNamePrefix ", x, sep="")
print(cmd.gz)
system(cmd.gz)

}else{
# if the fastq is not zipped
cmd.notZipped<-paste("STAR --genomeDir ", ref_dir, " --readFilesIn ", x, " --runThreadN 7 --outSAMtype BAM SortedByCoordinate --scoreDelOpen -10000 --scoreInsOpen -10000 --outFilterMultimapNmax 1 --outFilterMismatchNmax 2 --outSAMunmapped Within --outFileNamePrefix ", x, sep="")
print(cmd.notZipped)
...
#create proj file this will make the BAM files, uses BWA internally
