...
groups=c("group","batch","pool") # Column name(s) in your metadata to use for annotations of experimental groups
Platform <- "TempO-Seq" # Or RNASeq
```
...
correlation_df_all_heatmap <- correlation_df_all[,c("batch",
                                                    "technical_control",
                                                    "reference_rna",
                                                    "solvent_control")]
...
correlation_df_samples_heatmap <- correlation_df_samples[,c("batch",
                                                    "pool",
                                                    "technical_control",
                                                    "reference_rna",
                                                    "solvent_control")]
