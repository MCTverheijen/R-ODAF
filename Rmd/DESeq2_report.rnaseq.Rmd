...
params:
  ...
  project_name: "Flame_retardants"     # Change depending on your project name
...
```{r 'pathway_analysis', collapse=TRUE, eval=params$run_pathway_analysis}
...
```{r 'pathway_analysis_by_contrast_make_plots', collapse=TRUE, eval=params$run_pathway_analysis}
plotList <- list()
...
```{r 'pathway_analysis_by_contrast_print_plots', results='asis', eval=params$run_pathway_analysis}
for (i in seq_along(levels(significantResults$contrast))) {
...
```{r 'gsea_analysis_by_contrast_make_plots', collapse=TRUE, eval=params$run_pathway_analysis}
plotListGSEA <- list()
...
```{r 'gsea_analysis_by_contrast_print_plots', results='asis', eval=params$run_pathway_analysis}
for (i in seq_along(levels(significantResults$contrast))) {
  cat("###", levels(significantResults$contrast)[i], "  \n\n")
...
```{r 'gsea_scores_plot', results='asis', eval=params$run_pathway_analysis}
