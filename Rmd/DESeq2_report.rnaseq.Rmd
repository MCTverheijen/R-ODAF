...
clusterProfiler::dotplot(enrich_go_all %>% filter(ONTOLOGY=="BP"), font.size=9, showCategory=20)  +
  theme(axis.text.y = element_text(angle = 0)) +
...
clusterProfiler::dotplot(enrich_go_all %>% filter(ONTOLOGY=="MF"), font.size=9)  +
   theme(axis.text.y = element_text(angle = 0)) +
  scale_y_discrete(labels = function(x) stringr::str_wrap(x, width = 30))
```
