...
params:
  ...
  project_name: "Tiparp_TCDD"     # Change depending on your project name
  ...
  intgroup: ["Group","Genotype"]           # experimental group of interest plus covariates; can be more than one
