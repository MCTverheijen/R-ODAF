...
params:
  ...
  project_name: "Template"     # Change depending on your project name
  ...
  intgroup: ["group","dose"]           # experimental group of interest plus covariates; can be more than one
  ...
  group_filter: "male"           # Which group will this report be done on?
