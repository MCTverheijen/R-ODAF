...
if (file.exists(file.path(paths$RData, "dds.RData")) & is.null(params$group_facet)) {
  ...
  if (!identical(as.data.frame(round(counts(dds))),
    ...
    if(file.exists(file.path(paths$RData, paste0("dds_", params$group_filter, ".RData"))) & !is.null(params$group_facet)) {
